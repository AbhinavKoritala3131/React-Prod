...
const AuthPage = () => {
  ...
  return (
    <div className="auth-page">
      ...
      >
        <div className="header">VECTROLLA</div>
        <p className="tagline">Drive Business Forward—All Your Projects, One Platform.</p>
        ...
        <div className="footer">© 2025 Vectrolla. All rights reserved.</div>
      </div>
    </div>
  );
};
